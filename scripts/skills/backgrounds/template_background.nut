this.NEWNAME_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	m = {},
	function create()
	{
		this.character_background.create();
		this.m.ID = "background.NEWNAME";
		this.m.Name = "NEWNAME";
		this.m.Icon = "ui/backgrounds/background_NEWNAME.png";
