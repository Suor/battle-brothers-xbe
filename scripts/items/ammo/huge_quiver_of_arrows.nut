this.huge_quiver_of_arrows <- this.inherit("scripts/items/ammo/ammo", {
	...
	function create()
	{
		...
		this.m.Name = "Enhanced Large Quiver of Arrows";
		this.m.Description = "A large quiver of arrows, enhanced by the expertise of a fletcher and required to use bows of all kinds. Is automatically refilled after each battle if you have enough ammunition.";
