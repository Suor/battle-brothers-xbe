this.huge_quiver_of_bolts <- this.inherit("scripts/items/ammo/ammo", {
	...
	function create()
	{
		...
		this.m.Name = "Enhanced Large Quiver of Bolts";
		this.m.Description = "A large quiver of bolts, enhanced by the expertise of a fletcher and required to use crossbows. Is automatically refilled after each battle if you have enough ammunition.";
