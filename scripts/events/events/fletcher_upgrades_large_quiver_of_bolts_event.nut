this.fletcher_upgrades_large_quiver_of_bolts_event <- this.inherit("scripts/events/event", {
	m = {
		Fletcher = null
	},
	function create()
	{
		...
		this.m.Screens.push({
			ID = "A",
			Text = "[img]gfx/ui/events/event_82.png[/img][M] As you\'re taking inventory during camp, %fletcher% walks in and hands you a quiver packed tightly with bolts. %SPEECH_ON%Got a look at the quivers our bowmen had to work with, captain. Figured I would apply my knowledge to get them to hold a few extra. No big deal, had some spare materials and time to do it.%SPEECH_OFF% Without waiting for an answer, %fletcher% walks away, leaving you to your work.",
			Image = "",
			List = [],
			Characters = [],
			Options = [
